...
mapattr -c landmask.map totalEvaporation_annuaTot_output.2003.map

# only use the value within the landmask
pcrcalc totalEvaporation_annuaTot_output.2003.map = "if(landmask.map, totalEvaporation_annuaTot_output.2003.map)"
